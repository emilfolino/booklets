javascript:(function(){
    ...
    .then(function(myJson) {
        ...
        <option value='Jag har tittat på ditt projekt. Bra jobbat med både koden och presentationen! Du kan se matrisen för betyget om du klickar på länken 'visa matris'. Svara gärna på kursvärderingen som bör komma strax efter kursens slut då den ligger till stöd för kommande versioner av kursen.'>js1 10</option>\
